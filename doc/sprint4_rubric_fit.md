...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 9 / 10 Feedback: Not all standup numbers match for example some start with Sprint 4 standup 2 and some members post their standup messages late causing discrepancies between meeting numbers
...
## Tracking on Jira  (max 24 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    Your Mark: 1 Feedback: 102 and 104 are missing
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 1 Feedback some commit messages are vague like "Fixed minor bug"
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 2 Feedback: There were 2 tasks that were incomplete by 2 different members
...
## Sprint Completion (Max 20 marks) 
  ...
  Your Mark: 16 / 20 Feedback: Two user stories were incomplete, reading the explanation of the feature taking up time I deducted 2 marks for each user story.
...
## Sprint Demo (Max 14 marks) 
  ...
  - Working software (max 2 marks)
    ...
    Feedback: Reloading glitch but got it back on track
